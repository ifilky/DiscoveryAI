  ...
  return (
    <PostModelo fotoCapa={fotoCapa} titulo="Sobre o autor">
      ...
      <p className={styles.paragrafo}>
        E aí, beleza? Eu sou estudante do curso de Sistemas de Informação. No momento, trabalho como suporte de sistema ERP, mas sou um grande entusiasta da programação e das incríveis soluções que ela pode criar para os mais diversos tipos de situações.
      </p>
      <p className={styles.paragrafo}>
